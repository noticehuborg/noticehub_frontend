...
export default function Modal({
  ...
  function handlePanelPointerDown(e) {
    ...
    const isScrolled = panelRef.current
      ? Array.from(panelRef.current.querySelectorAll("*")).some(
          (el) => el.scrollTop > 0,
        )
      : false;
      ...
      >
        ...
        {isMobile && dragHandle && (
          <div
            ...
            className="absolute top-0 inset-x-0 flex justify-center pt-2.5 bg-white pb-2 z-20 cursor-grab active:cursor-grabbing touch-none select-none"
            aria-hidden="true"
          >
